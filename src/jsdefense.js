...
(function() {
  ...
  Map = (function(_super) {
    ...
    function Map() {
      this.bindDragEvents = __bind(this.bindDragEvents, this);      this.tiles = new Array(0);
    }
    ...
    Map.prototype.addTower = function(options) {
      var tower;
      tower = this.game.tf.create(options);
      tower.load(this.game);
      return tower;
    };
  ...
  Tower = (function(_super) {
    ...
    function Tower(_arg) {
      this.name = _arg.name, this.tile = _arg.tile;
      this.cls = _arg.type;
    }
